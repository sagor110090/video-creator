        ...
        <div :class="[
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                >
                    ...
                    <svg v-else-if="item.icon === 'CalendarIcon'" class="mr-3 h-5 w-5 flex-shrink-0" :class="url === item.href ? 'text-indigo-600 dark:text-indigo-400' : 'text-slate-400 group-hover:text-slate-500 dark:group-hover:text-slate-300'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
