...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/stories/{story}/upload-facebook', [StoryController::class, 'uploadToFacebook']);
    ...
    Route::get('/facebook/pages', [\App\Http\Controllers\FacebookController::class, 'pages']);
    Route::delete('/facebook/pages/{id}', [\App\Http\Controllers\FacebookController::class, 'disconnect']);
